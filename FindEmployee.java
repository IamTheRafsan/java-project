...
public class FindEmployee extends JFrame implements MouseListener, ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (findBtn.getText().equals(command)) {
            ...
            try {
                ...
                showMessageDialog(null, "There was a problem!");
            }
